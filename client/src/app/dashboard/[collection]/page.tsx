...
export default function CollectionChatPage() {
    ...
    const handleChatSubmit = async (e: React.FormEvent) => {
        e.preventDefault()
        console.log("Handling chat submit with userInput:", userInput, "and collectionName:", collectionName);
        ...
        try {
            ...
            const aiMessage = {
                ...
                content: data.response || "Sorry, I couldn't find an answer to your question."
            }
                    ...
                    <div className="flex items-center gap-2 sm:gap-4">
                        ...
                        <div className="flex items-center gap-2 sm:gap-3">
                            ...
                            <div className="min-w-0">
                                <h1 className="text-lg sm:text-xl font-bold truncate">Chat with {collectionName}</h1>
                                {currentCollection && (
                        ...
                        <AnimatePresence>
                            {chatHistory.length === 0 ? (
                                ...
                                >
                                    <AILogo size="lg" />
                                    <div>
                                        <h3 className="text-lg sm:text-xl font-semibold text-white mb-2">Ready to Chat!</h3>
                                        <p className="text-sm sm:text-base text-white/60">Ask me anything about {currentCollection?.url}</p>
                                    </div>
                                </motion.div>
                            ) : (
