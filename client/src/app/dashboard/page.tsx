        ...
        <PageBackground variant="dashboard">
            <div className="min-h-screen flex flex-col">
                ...
                >
                    <div className="flex items-center gap-2 sm:gap-4">
                        ...
                        <div className="flex items-center gap-2 sm:gap-3">
                            <AILogo size="md" />
                            <div>
                                <h1 className="text-lg sm:text-xl font-bold">Website AI Dashboard</h1>
                            </div>
                        </div>
                    </div>
                </motion.header>
                ...
                <main className="flex-1 container mx-auto p-4 sm:p-6 flex flex-col max-w-4xl">
                    ...
                    >
                        {/* URL Input Section */}
                        <motion.div variants={fadeInUp} className="w-full max-w-lg space-y-4 sm:space-y-6">
                        ...
                        {collections.length > 0 && (
                            <motion.div variants={fadeInUp} className="w-full max-w-lg mt-8 sm:mt-12">
                                <h3 className="text-base sm:text-lg font-semibold mb-3 sm:mb-4 text-white/80">Recent Websites</h3>
                                    ...
                                    {collections.map((collection) => (
                                        ...
                                        >
                                            <div className="flex items-center gap-2 sm:gap-3 min-w-0">
                                                <Globe size={14} className="text-white/60 flex-shrink-0 sm:w-4 sm:h-4" />
                                                <div className="min-w-0">
                                                    <p className="text-white text-sm font-medium truncate">{collection.name}</p>
                                                    <p className="text-white/40 text-xs truncate">{collection.url}</p>
                                                </div>
                                            </div>
                                            <Button
                                                variant="ghost"
